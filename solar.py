...
print( type( i0 ))
i0.pv_string.append( make_string( 0 ) ) # One pv_string.
i0.pv_string.append( make_string( 1 ) ) # A second pv_string.
...
for inverter1 in range(20):
    ...
    pv_inverter[inverter1].pv_string.append( make_string( inverter1 ) ) # One pv_string.
    k = input( 'Hit [enter]' )
...
for inverter2 in range(16, 20):
    ...
    pv_inverter[inverter2].pv_string.append( make_string( inverter2 + 4 ) ) # A second pv_string.
    k = input( 'Hit [enter]' )
